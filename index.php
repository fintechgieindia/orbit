...
<div class="page-wrapper">
	...
	<div id="smooth-wrapper">
        <div id="smooth-content">
			...
			<div class="slider-two_pattern overlay-layer" style="--slide-bg: url('assets/images/main-slider/banner-1.png');"></div>
			...
			<div class="slider-two_pattern overlay-layer" style="--slide-bg: url('assets/images/main-slider/banner-2.png');"></div>
							<div class="auto-container">
								<!-- Content Column -->
								<div class="slider-two_content">
									<div class="slider-two_content-inner">
			...
			<div class="slider-two_pattern overlay-layer" style="--slide-bg: url('assets/images/main-slider/banner-3.png');"></div>
						...
						<div class="welcome-one_image-column col-lg-6 col-md-12 col-sm-12">
							<div class="welcome-one_image-outer">
								<div class="welcome-one_image trans-900">
									<img src="assets/images/background/abo.png" alt="" />
								</div>
							</div>
						</div>
						...
						<div class="welcome-one_content-column col-lg-6 col-md-12 col-sm-12">
							<div class="welcome-one_content-outer">
								<div class="sec-title title-anim">
									...
									<h3 class="sec-title_heading ">We’re Here to Make Your Water Needs Simple and Reliable</h3>
								</div>
			...
			<section class="project-two">
				<div class="auto-container">
					<div class="sec-title title-anim centered">
						...
						<h3 class="sec-title_heading">Our Construction Project For Client</h3>
					</div>
						...
						<div class="project-block_three">
						  <div class="inner">
							...
							<div class="content">
							  ...
							  <div class="icon flaticon-agencyo-cloud-application"></div>
							  <div class="sub-title">Borewell / Groundwater Works</div>
							  <h3 class="title">Deep Borewell Installation for Agriculture</a></h3>
						...
						<div class="project-block_three">
						  <div class="inner">
							...
							<div class="content">
							  ...
							  <div class="icon flaticon-agencyo-cloud-application"></div>
							  <div class="sub-title">Borewell / Groundwater Works</div>
							  <h3 class="title">Submersible Pump Setup & Testing</a></h3>
			  	...
			  	<section class="process-one">
							<div class="auto-container">
								...
								<div class="sec-title title-anim centered">
									...
									<h3 class="sec-title_heading ">How We Work Our Borewell<br>  Service Steps </h3>
								</div>
							</div>
...
/* Make sure slide content stays above image */
.slider-two_content {
    position: relative;
    z-index: 2;
}
...
.cta-one {
    ...
    background-position: center;
    background-repeat: no-repeat;
    padding: 100px 0; /* adjust if needed */
}
...
.cta-one::before {
    ...
    background: linear-gradient(
        to right,
        rgba(20, 23, 108, 0.8),   /* #14176c */
        rgba(247, 164, 0, 0.8)   /* #f7a400 */
    );
...
<!-- Mirrored from themecraze.net/html/qonstruct/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Dec 2025 07:13:36 GMT -->
</html>