          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="footer-widget links-widget">
              ...
              <ul class="footer-list">
                ...
                <li><a href="services.php#repair">Repair</a></li>
            ...
            <div class="footer-widget footer-subscription">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="d-flex align-items-start gap-2 mb-2">
                  ...
                  <span style="color:#fff">Sankari Road, Tiruchengode, Namakkal-637211, Tamil Nadu, India.</span>
                </li>
                <!-- Email -->
                ...
                <li class="d-flex align-items-center gap-3">
                  ...
                  <span>
                    <a href="tel:+916046778990">+91 6046778990</a> | 
                    <a href="tel:+917376543339">+91 7376543339</a>
                  </span>
                </li>
              </ul>
            </div>
